...
class MapManager():
    ...
    def load_graph(self): ##Acá se genera el grafo a mano. Se podría poner en un archivo y luego cargarlo, sería más modular
        ...
        self.G.add_edge(1, 5, length=190)
        self.G.add_edge(5, 2, length=130)
        self.G.add_edge(2, 3, length=330)
        self.G.add_edge(3, 4, length=360)
        self.G.add_edge(2, 4, length=190)
