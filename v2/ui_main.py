...
################################################################################
## Form generated from reading UI file 'GUI_BASEgocdNQ.ui'
##
...
"background-image: url(:/16x16/icons/16x16/cil-truck.png);\n"
"background-position: center;\n"
...
"")
        ...
        self.cmd_icon_2 = QFrame(self.frame_9)
        self.cmd_icon_2.setObjectName(u"cmd_icon_2")
        self.cmd_icon_2.setMaximumSize(QSize(20, 30))
        self.cmd_icon_2.setStyleSheet(u"background: transparent;\n"
"background-image: url(:/16x16/icons/16x16/cil-comment-square.png);\n"
"background-position: center;\n"
"background-repeat: no-repeat;")
        self.cmd_icon_2.setFrameShape(QFrame.StyledPanel)
        self.cmd_icon_2.setFrameShadow(QFrame.Raised)

        self.horizontalLayout_14.addWidget(self.cmd_icon_2)

        self.cmd_line_name_2 = QLabel(self.frame_9)
        self.cmd_line_name_2.setObjectName(u"cmd_line_name_2")
        self.cmd_line_name_2.setMaximumSize(QSize(16777215, 20))
        self.cmd_line_name_2.setFont(font1)
        self.cmd_line_name_2.setStyleSheet(u"")
        self.cmd_line_name_2.setLineWidth(1)
        self.cmd_line_name_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_14.addWidget(self.cmd_line_name_2)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 328, 395))
...
"background-image: url(:/16x16/icons/16x16/cil-map.png);\n"
"background-position: center;\n"
"background-repeat: no-repeat;")
        self.cmd_icon_3.setFrameShape(QFrame.StyledPanel)
        self.cmd_icon_3.setFrameShadow(QFrame.Raised)
        ...
        self.cmd_line_name_3.setStyleSheet(u"")
        self.cmd_line_name_3.setLineWidth(1)
        self.cmd_line_name_3.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.agv_data_frame_w_titles = QFrame(self.frame_4)
        self.agv_data_frame_w_titles.setObjectName(u"agv_data_frame_w_titles")
        self.agv_data_frame_w_titles.setMaximumSize(QSize(200, 16777215))
...
"background-repeat: no-repeat;")
        ...
        self.agv_data_flag_in_mission.setMaximumSize(QSize(16, 16))
        ...
        font5.setBold(True)
        font5.setWeight(75)
        self.in_mission_title.setFont(font5)
        ...
        self.agv_data_flag_mission_paused.setMaximumSize(QSize(16, 16))
        ...
        self.mission_paused_title.setFont(font5)
        ...
        self.agv_data_flag_waiting_for_IBE.setMaximumSize(QSize(16, 16))
        ...
        self.waiting_for_IBE_title.setFont(font5)
        ...
        self.agv_data_flag_emergency.setMaximumSize(QSize(16, 16))
        ...
        self.emergency_title.setFont(font5)
        ...
        self.agv_data_flag_error.setMaximumSize(QSize(16, 16))
        ...
        self.error_title.setFont(font5)
        ...
        self.agv_data_flag_waiting_for_continue.setMaximumSize(QSize(16, 16))
        ...
        self.waiting_for_continue_title.setFont(font5)
        ...
        self.horizontalLayout_16.addWidget(self.agv_data_frame_w_titles)
...
"}")
        ...
        self.cmd_icon = QFrame(self.frame_6)
        self.cmd_icon.setObjectName(u"cmd_icon")
        self.cmd_icon.setMaximumSize(QSize(20, 20))
        self.cmd_icon.setStyleSheet(u"background: transparent;\n"
"background-image: url(:/16x16/icons/16x16/cil-terminal.png);\n"
"background-position: center;\n"
"background-repeat: no-repeat;")
        self.cmd_icon.setFrameShape(QFrame.StyledPanel)
        self.cmd_icon.setFrameShadow(QFrame.Raised)

        self.horizontalLayout_13.addWidget(self.cmd_icon)

        self.cmd_line_name = QLabel(self.frame_6)
        self.cmd_line_name.setObjectName(u"cmd_line_name")
        self.cmd_line_name.setMaximumSize(QSize(16777215, 20))
        self.cmd_line_name.setFont(font1)
        self.cmd_line_name.setStyleSheet(u"")
        self.cmd_line_name.setLineWidth(1)
        self.cmd_line_name.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_13.addWidget(self.cmd_line_name)
...
"")
        ...
        self.page_data.setEnabled(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.waiting_for_continue_title.setText(QCoreApplication.translate("MainWindow", u"Wait for continue", None))
